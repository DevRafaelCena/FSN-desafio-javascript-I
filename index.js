    ...
    */
    ...
    for (let i = 0; i < alunosDaEscola.length; i++) {
        if (alunosDaEscola[i].nome === aluno) {
            ...
            console.log("Nota : " + nota + " para o aluno: " + alunosDaEscola[i].nome)
            matricula = 1
...
function aprovarAluno(aluno) {
    ...
    for (let i = 0; i < alunosDaEscola.length; i++) {
        ...
        if (alunosDaEscola[i].nome === aluno) {
            ...
            var total = alunosDaEscola[i].notas.reduce(function (total, nota) {
                return total + nota;
            })

            if (total / alunosDaEscola[i].notas.length >= 7 & alunosDaEscola[i].faltas < 3) {
                console.log(`O Aluno ${alunosDaEscola[i].nome} foi APROVADO!!!`)
            } else {
                console.log(`O Aluno ${alunosDaEscola[i].nome} foi REPROVADO!!!`)
            }
